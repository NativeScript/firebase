...
export class Transaction implements ITransaction {
  ...
  update(documentRef: any, field: any, value?: any, moreFieldsAndValues?: any): Transaction {
    ...
    if (arguments.length === 2) {
      transaction = this.native.update(
        documentRef.native, serializeItems(field)
      )
    } else {
      if (field instanceof FieldPath) {
        transaction = this.native.update(
          documentRef.native, field.native, value?.native || value || null, moreFieldsAndValues?.map(value => value?.native || value) ?? []
        )
      } else {
        transaction = this.native.update(
          documentRef.native, field.native, value?.native || value || null, moreFieldsAndValues?.map(value => value?.native || value) ?? []
  ...
  set<T extends DocumentData = DocumentData>(documentRef: DocumentReference<T>, data: T, options?: SetOptions): Transaction {
    ...
    if (options) {
      if (typeof options?.merge === 'boolean') {
        transaction = this.native.set(
          serializeItems(data), documentRef.native, com.google.firebase.firestore.SetOptions.merge()
        )
      } else if (options.mergeFields) {
        if (Array.isArray(options.mergeFields)) {
          if (typeof options.mergeFields[0] === 'string') {
            transaction = this.native.set(serializeItems(data), documentRef.native, com.google.firebase.firestore.SetOptions.mergeFields(
              options.mergeFields as any
            ));
          } else {
  ...
  get(options?: GetOptions): Promise<QuerySnapshot> {
    ...
    return new Promise((resolve, reject) => {
      org.nativescript.firebase.firestore.FirebaseFirestore.Query.get(
        this.native, source, new org.nativescript.firebase.firestore.FirebaseFirestore.Callback<com.google.firebase.firestore.QuerySnapshot>({
          onError(error) {
  ...
  delete(): Promise<void> {
    return new Promise((resolve, reject) => {
      org.nativescript.firebase.firestore.FirebaseFirestore.DocumentReference.delete(
        this.native, new org.nativescript.firebase.firestore.FirebaseFirestore.Callback<java.lang.Void>({
          onSuccess(param0) {
            resolve()
          },
          onError(error) {
  ...
  get(options?: GetOptions): Promise<DocumentSnapshot<T>> {
    return new Promise((resolve, reject) => {
      ...
      org.nativescript.firebase.firestore.FirebaseFirestore.DocumentReference.get(
        this.native, source, new org.nativescript.firebase.firestore.FirebaseFirestore.Callback<com.google.firebase.firestore.DocumentSnapshot>({
          onSuccess(ss) {
      ...
      if (options) {
        if (typeof options?.merge === 'boolean') {
          org.nativescript.firebase.firestore.FirebaseFirestore.DocumentReference.set(
            this.native,
            serializeItems(data), com.google.firebase.firestore.SetOptions.merge(),
          ...
          if (Array.isArray(options.mergeFields)) {
            if (typeof options.mergeFields[0] === 'string') {
              org.nativescript.firebase.firestore.FirebaseFirestore.DocumentReference.set(
                this.native,
                serializeItems(data), com.google.firebase.firestore.SetOptions.mergeFields(options.mergeFields as any),
                new org.nativescript.firebase.firestore.FirebaseFirestore.Callback<java.lang.Void>({
                  onSuccess(param0) {
                    resolve()
                  },
              ...
              org.nativescript.firebase.firestore.FirebaseFirestore.DocumentReference.set(
                this.native,
                serializeItems(data), com.google.firebase.firestore.SetOptions.mergeFieldPaths(list),
                new org.nativescript.firebase.firestore.FirebaseFirestore.Callback<java.lang.Void>({
                  onSuccess(param0) {
                    resolve()
                  },
    ...
    return new Promise((resolve, reject) => {
      if (arguments.length === 1) {
        org.nativescript.firebase.firestore.FirebaseFirestore.DocumentReference.update(
          this.native, serializeItems(arguments[0]),
          new org.nativescript.firebase.firestore.FirebaseFirestore.Callback<java.lang.Void>({
            onSuccess(param0) {
              resolve()
            },
        ...
        if (field instanceof FieldPath) {
          org.nativescript.firebase.firestore.FirebaseFirestore.DocumentReference.update(
            this.native, field.native, value?.native || value || null, moreFieldsAndValues?.map(value => value?.native || value) ?? [],
            new org.nativescript.firebase.firestore.FirebaseFirestore.Callback<java.lang.Void>({
              onSuccess(param0) {
                resolve()
              },
          ...
          org.nativescript.firebase.firestore.FirebaseFirestore.DocumentReference.update(
            this.native, field, value?.native || value || null, moreFieldsAndValues?.map(value => value?.native || value) ?? [],
            new org.nativescript.firebase.firestore.FirebaseFirestore.Callback<java.lang.Void>({
              onSuccess(param0) {
                resolve()
              },
  ...
  set(documentRef: DocumentReference, data: DocumentData, options?: SetOptions): WriteBatch {
    if (options) {
      ...
      if (options.mergeFields) {
        if (Array.isArray(options.mergeFields)) {
          if (typeof options.mergeFields[0] === 'string') {
            return WriteBatch.fromNative(this.native.set(serialize(data), documentRef.native, com.google.firebase.firestore.SetOptions.mergeFields(
              options.mergeFields as any
            )));
          }
          ...
          return WriteBatch.fromNative(
            this.native.set(
              serialize(data),
              documentRef.native,
              com.google.firebase.firestore.SetOptions.mergeFields(list)
            )
          );
        }
      }
      ...
      org.nativescript.firebase.firestore.FirebaseFirestore.runTransaction(
        ...
        new org.nativescript.firebase.firestore.FirebaseFirestore.TransactionCallback({
          onTransaction(transaction: com.google.firebase.firestore.Transaction, returnValue: androidx.lifecycle.MutableLiveData<any>, lock: java.util.concurrent.CountDownLatch) {
            updateFunction(Transaction.fromNative(transaction)).then(value => {
