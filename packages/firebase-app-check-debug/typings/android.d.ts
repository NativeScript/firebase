	...
	export module google {
		export module firebase {
			export module appcheck {
				export module debug {
					export class BuildConfig {
						public static class: java.lang.Class<com.google.firebase.appcheck.debug.BuildConfig>;
						public static DEBUG: boolean = 0;
						public static LIBRARY_PACKAGE_NAME: string = 'com.google.firebase.appcheck.debug';
						public static BUILD_TYPE: string = 'release';
						public static VERSION_NAME: string = '19.4.1';
						public constructor();
					}
...
declare module com {
	export module google {
		export module firebase {
			export module appcheck {
				export module debug {
					export class FirebaseAppCheckDebugRegistrar {
						public static class: java.lang.Class<com.google.firebase.appcheck.debug.FirebaseAppCheckDebugRegistrar>;
						public constructor();
						public getComponents(): java.util.List<com.google.firebase.components.Component<any>>;
					}
				}
...
declare module com {
	export module google {
		export module firebase {
			export module appcheck {
				export module debug {
					export class InternalDebugSecretProvider {
						public static class: java.lang.Class<com.google.firebase.appcheck.debug.InternalDebugSecretProvider>;
						/**
						 * Constructs a new instance of the com.google.firebase.appcheck.debug.InternalDebugSecretProvider interface with the provided implementation. An empty constructor exists calling super() when extending the interface class.
						 */
						public constructor(implementation: { getDebugSecret(): string });
						public constructor();
						public getDebugSecret(): string;
					}
				}
			}
		}
			...
			export module appcheck {
				export module debug {
					export module internal {
						export class DebugAppCheckProvider extends com.google.firebase.appcheck.AppCheckProvider {
							public static class: java.lang.Class<com.google.firebase.appcheck.debug.internal.DebugAppCheckProvider>;
							public constructor(firebaseApp: com.google.firebase.FirebaseApp, debugSecretProvider: com.google.firebase.inject.Provider<com.google.firebase.appcheck.debug.InternalDebugSecretProvider>, liteExecutor: java.util.concurrent.Executor, backgroundExecutor: java.util.concurrent.Executor, blockingExecutor: java.util.concurrent.Executor);
							public getLimitedUseToken(): com.google.android.gms.tasks.Task<com.google.firebase.appcheck.AppCheckToken>;
							public getToken(): com.google.android.gms.tasks.Task<com.google.firebase.appcheck.AppCheckToken>;
						}
					}
	...
	export module google {
		export module firebase {
			export module appcheck {
				export module debug {
					export module internal {
						export class ExchangeDebugTokenRequest {
							public static class: java.lang.Class<com.google.firebase.appcheck.debug.internal.ExchangeDebugTokenRequest>;
							public toJsonString(): string;
							public constructor(debugToken: string, isLimitedUseToken: boolean);
						}
					}
				}
			}
				...
				export module debug {
					export module internal {
						export class StorageHelper {
							public static class: java.lang.Class<com.google.firebase.appcheck.debug.internal.StorageHelper>;
							public constructor(context: globalAndroid.content.Context, persistenceKey: string);
							public saveDebugSecret(debugSecret: string): void;
							public retrieveDebugSecret(): string;
						}
					}
				}
			}
