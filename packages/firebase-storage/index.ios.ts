import { FirebaseApp, FirebaseError, deserialize, serialize, firebase } from '@nativescript-asharghi/firebase-core';
import { TaskState, TaskEvent, StringFormat } from './common';
