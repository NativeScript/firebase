...
enum TNSFirebaseNotificationAndroidVisibility: Int, Codable {
...
enum TNSFirebaseNotificationAndroidPriority: Int, Codable {
    typealias RawValue = Int
...
class TNSNotificationCriticalSound: Codable {
    
}

struct TNSNotificationIOSCriticalSound: Codable {
    var critical: Bool?
    var name: String
    var volume: Int?
}

struct TNSFirebaseNotificationAndroid: Codable {
    ...
    var imageUrl: String?
    var link: String?
    var priority: TNSFirebaseNotificationAndroidPriority
    var smallIcon: String?
    var sound: String?
    var ticker: String
    var visibility: TNSFirebaseNotificationAndroidVisibility
}

struct TNSFirebaseNotificationIOS: Codable {
    var badge: String
    var sound: TNSNotificationCriticalSound?  /* String | TNSNotificationIOSCriticalSound */
    var subtitle: String
    var subtitleLocArgs: Array<String>?
    var subtitleLocKey: String
}

struct TNSFirebaseNotification: Codable {
    var android: TNSFirebaseNotificationAndroid?
    var body: String?
    var bodyLocArgs: Array<String>?
    var bodyLocKey: String?
    var ios:TNSFirebaseNotificationIOS?
    var title: String?
    var titleLocArgs: Array<String>?
    var titleLocKey: String?
}

struct TNSFirebaseRemoteMessage: Codable {
    var category: String?
    ...
    var notification: TNSFirebaseNotification?
    var sentTime: Int?
    var threadId: String?
    var to: String?
    var ttl: Int?
